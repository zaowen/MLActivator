...
\begin{figure}
        \centering
        \includegraphics[width=0.8\linewidth]{figures/Adam30/relu_cifar10.pdf}
        \caption{relu}
\end{figure}

\begin{figure}
        \centering
        \includegraphics[width=0.8\linewidth]{figures/Adam30/selu_cifar10.pdf}
        \caption{relu}
\end{figure}

\begin{figure}
        \centering
        \includegraphics[width=0.8\linewidth]{figures/Adam30/sigmoid_cifar10.pdf}
        \caption{relu}
\end{figure}

\begin{figure}
        \centering
        \includegraphics[width=0.8\linewidth]{figures/Adam30/softmax_cifar10.pdf}
        \caption{relu}
\end{figure}

\begin{figure}
        \centering
        \includegraphics[width=0.8\linewidth]{figures/Adam30/tanh_cifar10.pdf}
        \caption{relu}
\end{figure}
